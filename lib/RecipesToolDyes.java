...
public class RecipesToolDyes implements IRecipe
{
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
	{
		...
		int var4 = 0;
		int var5 = 0;
		ItemDyeableToolMoreTools theTool = null;
		int slot;
		int toolColor;
		float var10;
		float var11;
		...
		for (slot = 0; slot < par1InventoryCrafting.getSizeInventory(); ++slot)
		{
			...
			if (stackInSlot != null)
			{
				if (stackInSlot.getItem() instanceof ItemDyeableToolMoreTools || stackInSlot.getItem() instanceof ItemDyeableSwordMoreTools || stackInSlot.getItem() instanceof ItemDyeableHoeMoreTools)
				{
					theTool = (ItemDyeableToolMoreTools) stackInSlot.getItem();
