...
public class TileEntitySpaceBlockRenderer extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderEndPortalTileEntity(TileEntitySpaceBlock par1TileEntitySpaceBlock, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderEndPortalTileEntity((TileEntitySpaceBlock)par1TileEntity, par2, par4, par6, par8);
    }
}
